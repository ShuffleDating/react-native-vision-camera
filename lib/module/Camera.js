...
export class Camera extends React.PureComponent {
  ...
  onRecordingStart() {
    var _this$props$onRecordi, _this$props2;
    (_this$props$onRecordi = (_this$props2 = this.props).onRecordingStart) === null || _this$props$onRecordi === void 0 || _this$props$onRecordi.call(_this$props2);
  }
  onStarted() {
    var _this$props$onStarted, _this$props3;
    (_this$props$onStarted = (_this$props3 = this.props).onStarted) === null || _this$props$onStarted === void 0 || _this$props$onStarted.call(_this$props3);
  }
  onStopped() {
    var _this$props$onStopped, _this$props4;
    (_this$props$onStopped = (_this$props4 = this.props).onStopped) === null || _this$props$onStopped === void 0 || _this$props$onStopped.call(_this$props4);
  }
  //#endregion
