...
function useCameraPermission() {
  const [hasPermission, setHasPermission] = (0, _react.useState)(() => _Camera.Camera.getCameraPermissionStatus() === 'granted');
...
function useMicrophonePermission() {
  const [hasPermission, setHasPermission] = (0, _react.useState)(() => _Camera.Camera.getMicrophonePermissionStatus() === 'granted');
  const requestPermission = (0, _react.useCallback)(async () => {
